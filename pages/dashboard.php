      ...
      <div class="collapse navbar-collapse" id="navbar_content">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 flex-column flex-lg-row">
          <li class="nav-item mb-2 mb-lg-0 me-lg-3">
            ...
            <a class="btn btn-outline-light mb-2 mb-lg-0 ms-lg-2" href="#" data-bs-toggle="modal" data-bs-target="#download_certificates_modal">
  ...
  <div class="container-fluid pb-5">
    ...
    foreach ($categoriasLimite as $cat => $limite) {
        try {
            ...
            // Limit to maximum allowed hours
            if ($soma > $limite) {
                $soma = $limite;
            }
